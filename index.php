...
?>
    ...
    <div class="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56 text-center">
            ...
            <div class="mt-10 flex items-center justify-center gap-x-6">
                <a href="login.php" class="rounded-md bg-brand-blue px-4 py-2.5 text-sm font-semibold text-white shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Crear cuenta</a>
    ...
    <div class="mx-auto max-w-7xl py-24 sm:px-6 sm:py-32 lg:px-8">
        ...
        <div class="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
            ...
            <a href="login.php" class="rounded-md bg-brand-blue px-4 py-2.5 text-sm font-semibold text-white shadow">
                ¡Comienza ahora!
            </a>
