...
?>
    ...
    <div class="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56 text-center">
            <h1 class="text-5xl font-bold tracking-tight text-white sm:text-7xl">
                Organiza tu vida académica <span id="typed-text" class="text-brand-blue"></span>
            </h1>

            <p class="mt-8 text-lg leading-8 text-white sm:text-xl">
            ...
            <div class="mt-10 flex items-center justify-center gap-x-6">
                <a href="login" class="rounded-md bg-brand-blue px-4 py-2.5 text-sm font-semibold text-white shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Crear cuenta</a>
                <a href="#funciones" class="text-sm font-semibold text-white">Ver funciones <span aria-hidden="true">→</span></a>
            </div>
        </div>
    ...
    <div class="mx-auto max-w-7xl py-24 sm:px-6 sm:py-32 lg:px-8">
        ...
        <svg viewBox="0 0 1024 1024" class="absolute top-1/2 left-1/2 -z-10 size-256 -translate-y-1/2 mask-[radial-gradient(closest-side,white,transparent)] sm:left-full sm:-ml-80 lg:left-1/2 lg:ml-0 lg:-translate-x-1/2 lg:translate-y-0" aria-hidden="true">
            <circle cx="512" cy="512" r="512" fill="url(#gradient-todo)" />
            <defs>
                <radialGradient id="gradient-todo">
                <stop offset="50%" stop-color="rgba(88,101,242)" />
                <stop offset="100%" stop-color="#37409c" />
                </radialGradient>
            </defs>
        </svg>
        ...
        <div class="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
            ...
            <a href="login" class="rounded-md bg-brand-blue px-4 py-2.5 text-sm font-semibold text-white shadow">
                ¡Comienza ahora!
            </a>
        ...
        <div class="relative mt-16 h-80 lg:mt-8">
            <img class="absolute top-0 left-0 w-[38rem] max-w-none rounded-md bg-white/5 ring-1 ring-white/10"
                src="public/assets/images/todo.png"
    ...
    <div id="funciones">
        <div class="container mx-auto px-4 pb-14 relative isolate">
            ...
            <div class="max-w-2xl mx-auto text-center">
                <span class="text-sm text-white uppercase font-semibold tracking-wider">Funciones Principales</span>
                <h2 class="text-3xl md:text-4xl/tight font-semibold text-brand-blue mt-4">Todo lo que necesitas para organizar tu vida académica</h2>
                <p class="text-base font-medium mt-4 text-white">Administra tus materias, tareas, apuntes y notas con una sola plataforma moderna y práctica.</p>
            </div>
            ...
            <div class="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-x-3 gap-y-6 md:gap-y-12 lg:gap-y-20 md:pt-20 pt-12">
                ...
                <div class="text-center">
                    ...
                    <p class="text-base text-white/70 mt-2">Agrupa tus materias por periodo académico y asígnales íconos o colores.</p>
                </div>
                ...
                <div class="text-center">
                    ...
                    <p class="text-base text-white/70 mt-2">Crea tareas, asigna fechas y prioridades, y controla el estado de entrega.</p>
                </div>
                ...
                <div class="text-center">
                    ...
                    <p class="text-base text-white/70 mt-2">Escribe y guarda notas rápidas organizadas por cada materia.</p>
                </div>
                ...
                <div class="text-center">
                    ...
                    <p class="text-base text-white/70 mt-2">Lleva un promedio por materia y visualiza tu rendimiento en gráficos.</p>
                </div>
                ...
                <div class="text-center">
                    ...
                    <p class="text-base text-white/70 mt-2">Recibe alertas por correo antes de cada entrega o evaluación.</p>
                </div>
                ...
                <div class="text-center">
                    ...
                    <p class="text-base text-white/70 mt-2">Accede a un panel con estadísticas, historial y acceso a todo el sistema.</p>
                </div>
